...
# Define object categories including e-waste
...
# Separate e-waste category
ewaste_objects = ["laptop", "mouse", "remote", "keyboard", "cell phone", "microwave", "oven", "toaster", "sink", "refrigerator"]
...
while True:
    ...
    if len(indices) > 0:
        for i in indices.flatten():
            ...
            elif label in ewaste_objects:
                category = "E-Waste"
                color = (0, 255, 255)  # Cyan for e-waste
            else:
                category = "Other"
                color = (255, 255, 255)  # White for irrelevant objects
            ...
            if object_tracker[object_key]["count"] > 5:
                ...
                print(json.dumps(output_data, indent=4))  # Print the JSON for e-waste objects
